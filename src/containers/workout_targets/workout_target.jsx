...
class WorkoutTarget extends PureComponent {
  componentDidMount() {
    this._handleInitializeComponent();
  }

  constructor(props) {
    super(props);
    this._handleFormSubmit = this._handleFormSubmit.bind(this);
      this._handleInitializeComponent = this._handleInitializeComponent.bind(this);
  }
  ...
  _handleFormSubmit(formProps) {
    ...
    if (formProps.get('isCycledTraining') === 'fix' && _.isEmpty(onDays)) {
    ...
    if (
      ...
      (!formProps.get('startDayofTraining') || !formProps.get('onEveryxDay'))
    )
      throw new SubmissionError({
        isCycledTraining:
  ...
  render() {
    const { handleSubmit, isCycledTraining } = this.props;
    return (
      <WorkoutTargetForm
