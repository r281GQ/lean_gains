...
import DureWorkoutTarget, { PureWorkoutLogFormContainer } from './../../../src/containers/workout_logs/workout_log_form';
...
const store = createStore(
  combineReducers({
    ...
    workoutLogs: () => Map().set('dates', Set().add(moment('01-01-2017', 'DD-MM-YYYY').toDate())),
    formReducer
  })
);
